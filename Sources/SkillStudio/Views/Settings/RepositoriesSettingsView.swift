...
private struct RepositoryRowView: View {
    ...
    var body: some View {
        ...
        .alert("Remove Repository?", isPresented: $showDeleteConfirmation) {
            ...
            Text("This removes the repository config from SkillStudio. Local clone files are kept.")
        }
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            VStack(alignment: .leading, spacing: 6) {
                ...
                Text(syncOnLaunch
                     ? "This repository will auto-sync when SkillStudio starts."
...
struct AddRepositorySheet: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            VStack(alignment: .leading, spacing: 6) {
                Toggle("Sync on Launch", isOn: $syncOnLaunch)
                    .help("When enabled, this repository auto-syncs when SkillStudio starts. Disabled by default for better startup performance.")
