...
///
/// Responsibilities:
/// - Persist repository configurations to `~/.agents/.skillstudio-repos.json`
...
actor RepositoryManager {
    ...
    ///
    /// On first call, reads from `~/.agents/.skillstudio-repos.json`.
    ...
    private func cloneDirectly(repo: SkillRepository, httpAuthorization: String?) async throws {
        ...
        // gitService.cloneRepo clones to /tmp/SkillStudio-<UUID>/ first.
