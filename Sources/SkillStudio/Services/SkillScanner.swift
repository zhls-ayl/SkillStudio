...
///
/// Scanning strategy:
/// 1. First scan ~/.skillstudio/skills/ (canonical storage directory)
...
actor SkillScanner {
    ...
    /// Canonical skills directory (~/.skillstudio/skills/)
    ...
    func scanAll() async throws -> [Skill] {
        ...
        // 1. Scan new canonical directory (~/.skillstudio/skills/)
